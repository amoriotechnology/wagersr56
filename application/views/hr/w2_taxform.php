...
?>
         <body bgcolor="#A0A0A0" vlink="blue" link="blue">
            <div id="page2-div" style="position:relative;width:918px;height:1188px;    margin-left: 300px;">
               ...
               <p style="position:absolute;top:56px;left:236px;white-space:nowrap" class="ft23"><b>a &#160;</b>Employee’s social security number<br> <span style="color: #000; font-size: 14px;"><?php echo $e_details[0]['social_security_number']; ?></span></p>
               ...
               <p style="position:absolute;top:128px;left:508px;white-space:nowrap" class="ft23"><b>3 &#160;&#160;</b>Social security wages <br>
                  ...
                  <?php echo   isset($get_payslip_info[0]['overalltotal_amount']) ? '$'.number_format($get_payslip_info[0]['overalltotal_amount'], 2) : '0.00'; ?> </p>
              ...
              <?php
               ...
               <p style="position:absolute;top:344px;left:503px;white-space:nowrap" class="ft23"><b>14 &#160;</b>Other
                <br>
                  ...
                  <span>
                  <?php echo ($tax_info['tax'] ." ".$tax_info['code']); ?>  -  <?php echo number_format($tax_info['amount'], 2);?>    <br>
                  </span>  
                  <?php  endforeach; ?>
               ...
               <p style="position:absolute;top:434px;left:57px;white-space:nowrap" class="ft23">
                ...
                <p style="position:absolute;top:434px;left:296px;white-space:nowrap; text-align: center;" class="ft23">
                    ...
                    <span style="color: #000; font-size: 14px; position: relative;left: 30px;"> 
                    <?php echo !empty($matchedCode) ? htmlspecialchars($currency . $t_tax, ENT_QUOTES, 'UTF-8') : ''; ?>  
                        </span>
                    <span style="color: #000; font-size: 14px; position: relative; top: 30px;right: 37px;">
                        <?php echo !empty($matchedCode1) ? htmlspecialchars($currency . $t_tax, ENT_QUOTES, 'UTF-8') : ''; ?>  
                    </span> 
                </p>
                <?php 
                  $overalltotal_statetax = isset($stateTax[0]['overalltotal_statetax']) ? number_format($stateTax[0]['overalltotal_statetax'], 2) : '0.00';
               ...
               <p style="position:absolute;top:434px;left:427px;white-space:nowrap" class="ft23"><b>17 &#160;</b>State income tax
                  <br> 
                  <span style="color: #000; font-size: 14px; position: relative;left: 25px;">
                    <?php echo !empty($matchedCode) ? htmlspecialchars($currency . $overalltotal_statetax, ENT_QUOTES, 'UTF-8') : ''; ?>  
                  </span>
                  <span style="color: #000; font-size: 14px; position: relative; top: 30px;right:25px;">   
      ...
      <html xmlns="http://www.w3.org/1999/xhtml" lang="" xml:lang="">
         ...
         <body bgcolor="#A0A0A0" vlink="blue" link="blue">
            <div id="page3-div" style="position:relative;width:918px;height:1188px;    margin-left: 300px;">
               ...
               <p style="position:absolute;top:56px;left:236px;white-space:nowrap" class="ft32"><b>a &#160;</b>Employee’s social security number<br> <span style="color: #000; font-size: 14px;"><?php echo $e_details[0]['social_security_number']; ?></span></p>
...
<?php echo !empty($matchedCode) ? htmlspecialchars($c_details[0]['State_Tax_ID_Number'], ENT_QUOTES, 'UTF-8') : ''; ?>
               ...
               <p style="position:absolute;top:434px;left:296px;white-space:nowrap" class="ft32"><b>16 &#160;</b>State wages, tips, etc 
                  <br><span style="color: #000; font-size: 14px;position: relative;left: 30px;"> 
               ...
               <p style="position:absolute;top:434px;left:427px;white-space:nowrap" class="ft32"><b>17 &#160;</b>State income tax 
                  <br> <span style="color: #000; font-size: 14px;position: relative;left: 25px;">
                  <?php echo !empty($matchedCode) ? htmlspecialchars($currency . $overalltotal_statetax, ENT_QUOTES, 'UTF-8') : ''; ?> 
                  </span>
                  <span style="color: #000; font-size: 14px; position: relative; top: 30px;right:25px;">
                  <?php echo !empty($matchedCode1) ? htmlspecialchars($currency . $overalltotal_statetaxworking, ENT_QUOTES, 'UTF-8') : ''; ?>  
         ...
         <body bgcolor="#A0A0A0" vlink="blue" link="blue">
            <div id="page4-div" style="position:relative;width:918px;height:1188px;    margin-left: 300px;">
               ...
               <p style="position:absolute;top:36px;left:54px;white-space:nowrap" class="ft40">&#160; &#160; &#160;</p>
                <p style="position:absolute;top:65px;left:113px;white-space:nowrap" class="ft31">22222</p>
               <p style="position:absolute;top:56px;left:236px;white-space:nowrap" class="ft41"><b>a &#160;</b>Employee’s social security number<br> <span style="color: #000; font-size: 14px;"><?php echo $e_details[0]['social_security_number']; ?></span></p>
      ...
      <html xmlns="http://www.w3.org/1999/xhtml" lang="" xml:lang="">
         ...
         <body bgcolor="#A0A0A0" vlink="blue" link="blue">
            <div id="page6-div" style="position:relative;width:918px;height:1188px;     margin-left: 300px;">
               ...
               <p style="position:absolute;top:65px;left:113px;white-space:nowrap" class="ft31">22222</p>
               <p style="position:absolute;top:56px;left:236px;white-space:nowrap" class="ft61"><b>a &#160;</b>Employee’s social security number<br> <span style="color: #000; font-size: 14px;"><?php echo $e_details[0]['social_security_number']; ?></span></p>
      ...
      <html xmlns="http://www.w3.org/1999/xhtml" lang="" xml:lang="">
         ...
         <body bgcolor="#A0A0A0" vlink="blue" link="blue">
            <div id="page8-div" style="position:relative;width:918px;height:1188px;     margin-left: 300px;">
               ...
               <p style="position:absolute;top:65px;left:113px;white-space:nowrap" class="ft31">22222</p>
               <p style="position:absolute;top:56px;left:236px;white-space:nowrap" class="ft81"><b>a &#160;</b>Employee’s social security number<br> <span style="color: #000; font-size: 14px;"><?php echo $e_details[0]['social_security_number']; ?></span></p>
      ...
      <html xmlns="http://www.w3.org/1999/xhtml" lang="" xml:lang="">
         ...
         <body bgcolor="#A0A0A0" vlink="blue" link="blue">
            <div id="page10-div" style="position:relative;width:918px;height:1188px;     margin-left: 300px;">
               ...
               <p style="position:absolute;top:56px;left:236px;white-space:nowrap" class="ft102"><b>a &#160;</b>Employee’s social security number<br> <span style="color: #000; font-size: 14px;"><?php echo $e_details[0]['social_security_number']; ?></span></p>
...
async function generatePDF(elements) {
    try {
       ...
       window.location.href = "<?= base_url('Chrm/payroll_setting?id=' . $_GET['id']); ?>";
        ...
        pdf.save(`W2Form_${formattedDateTime}.pdf`);
    } catch (error) {
