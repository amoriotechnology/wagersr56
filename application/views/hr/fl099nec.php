    ...
    <body bgcolor="#A0A0A0" vlink="blue" link="blue">
        <div id="download">
            ...
            <div class="page-1" id="one">
                <img src="<?php echo base_url()  ?>assets/images/f1099_1.jpg" width="100%" />
            </div>

            <div class="page-2" id="two">
                <img src="<?php echo base_url()  ?>assets/images/f1099_2.jpg" width="100%" />
                <div class="void">
            ...
            <div class="page-3" id="three">
                <img src="<?php echo base_url()  ?>assets/images/f1099_3.jpg" width="100%" />
                <div class="void"> 
                    <input type="checkbox"   value=""  >
                </div>
                <div class="corrected">
		...
		<?php
            ...
            <div class="page-4" id="four">
                <img src="<?php echo base_url()  ?>assets/images/f1099_4.jpg" width="100%" />
                <div class="void">
                    <input type="checkbox"  value="" >
                </div>
                <div class="corrected">
            ...
            <div class="page-5" id="five">
                <img src="<?php echo base_url()  ?>assets/images/f1099_5.jpg" width="100%" />
            </div>

            <div class="page-6" id="six">
                <img src="<?php echo base_url()  ?>assets/images/f1099_6.jpg" width="100%" />
                <div class="void">
                    <input type="checkbox" value=""  >
                </div>
                <div class="corrected">
...
async function generatePDF(elements) {
    try {
       ...
       window.location.href = "<?= base_url('Chrm/payroll_setting?id=' . $_GET['id']); ?>";
        ...
        pdf.save(`F1099_${formattedDateTime}.pdf`);
    } catch (error) {
