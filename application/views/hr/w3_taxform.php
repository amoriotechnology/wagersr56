...
<p style="position:absolute;top:361px;left:62px;white-space:nowrap" class="ft216"><span> 
    <span style="color: black; font-size: large; position: absolute; bottom: 76px; word-wrap: break-word;">
   
    <?php
    // Assuming $address contains the address you want to wrap
    $wrapped_address = wordwrap(htmlspecialchars($address, ENT_QUOTES, 'UTF-8'), 40, "<br>\n", true);
    echo $wrapped_address;
    ?>
</span>
...
<p style="position:absolute;top:163px;left:647px;white-space:nowrap" class="ft22"><b>2&#160;</b>Federal income tax withheld    <br> <span style="color: black;font-size: large;"> $<?php echo number_format($ftotal_amount, 2) ; ?>          </p>
...
<?php
$overalltotal_statetax = isset($total_state_tax[0]['overalltotal_statetax']) ? number_format($total_state_tax[0]['overalltotal_statetax'], 2) : '0';
?>
...
<p style="position:absolute;top:451px;left:231px;white-space:nowrap" class="ft22"><b>17</b>&#160;State income tax <br> <span style="color: black;font-size: large;">$<?php echo htmlspecialchars(number_format($total_state_tax, 2), ENT_QUOTES, 'UTF-8'); ?>



<?php
$overalltotal_localtax = isset($total_local_tax[0]['overalltotal_localtax']) ? number_format($total_local_tax[0]['overalltotal_localtax'], 2) : '0';
?>
